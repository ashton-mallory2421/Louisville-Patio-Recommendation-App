...
ETL Workflow
1.	Extract
a.	API call to Open-Meteo
b.	Load restaurant data from CSV
2.	Transform
a.	Clean data
b.	Compute Patio Comfort Index
3.	Load
a.	Cleaned and structured data goes into Supabase
b.	Feed data into dashboard
## PCI Calculation:
